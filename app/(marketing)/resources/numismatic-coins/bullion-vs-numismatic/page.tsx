import Content, { frontmatter } from '@/content/resources/numismatic-coins/bullion-vs-numismatic.mdx'
import { PreLaunchBanner } from '@/components/compliance/PreLaunchBanner'

// Phase 2 route stub for /resources/numismatic-coins/bullion-vs-numismatic
