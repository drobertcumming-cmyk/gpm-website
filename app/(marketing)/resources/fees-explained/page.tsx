...
// /resources/fees-explained (moved from /pricing/ 2026-06-23)
//
...
// sharp-corner buttons, 880px reading column. Lives in the (marketing) route
// group, so SiteHeader / <main> / SiteFooter are inherited from
